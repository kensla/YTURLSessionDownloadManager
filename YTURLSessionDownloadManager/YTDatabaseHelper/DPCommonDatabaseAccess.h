...
#import "FMDatabase.h"
#import "DPDatabaseAccessTemplate.h"
/**
 *  数据库 通用事物操作类
 */
@interface DPCommonDatabaseAccess : NSObject
/**
 *  @brief  数据库操作模板，简化代码
 */
@property (nonatomic, strong) DPDatabaseAccessTemplate *databaseAccessTemplate;
